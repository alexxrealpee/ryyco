          ...
          <div className="flex items-center gap-2">
            ...
            <div>
              <span className="font-black text-xs sm:text-sm text-white uppercase tracking-tight block">
                {isExistingCustomer ? 'Inicia Sesión para Confirmar' : 'Crea tu Cuenta en 1 Paso'}
              </span>
              <span className="text-[10px] text-[#A9B2C3] font-semibold block">
                {isExistingCustomer ? 'Tu pedido está listo y se asociará a tu cuenta' : 'Tu pedido y todos tus datos están guardados'}
              </span>
            </div>
          </div>
        ...
        <div className="p-4 sm:p-5 space-y-4 max-h-[80vh] overflow-y-auto">
          ...
          <div>
            <button
              ...
              className="w-full h-11 bg-white hover:bg-gray-100 text-gray-900 font-bold text-xs rounded-xl flex items-center justify-center gap-2.5 transition active:scale-[0.98] shadow-md cursor-pointer disabled:opacity-50"
            >
              <GoogleIcon />
              <span>
                {isGoogleLoading ? 'Conectando con Google...' : isExistingCustomer ? 'Entrar con Google y Enviar Pedido' : 'Registrarme con Google y Enviar Pedido'}
              </span>
            </button>
          </div>
